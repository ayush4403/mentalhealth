...
class StudyMusicViewScreen extends StatefulWidget {
  final String title;
  final String imageUrl;
  final String audioUrl;
...
class _StudyMusicViewScreenState extends State<StudyMusicViewScreen> {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        leading: IconButton(
          ...
          color: Colors.white,
          onPressed: () {
            Navigator.of(context).pop(const StudyMusic());
          },
        ),
        title: const Text(
          'Serenity Scounds',
